...
def lambda_handler(event, context):
    ...
    total_open_properties=open_response_colorado[i]['@odata.totalCount']+open_response_pikes[i]['@odata.totalCount']
    total_closed_properties=closed_response_colorado[i]['@odata.totalCount']+closed_response_pikes[i]['@odata.totalCount']
